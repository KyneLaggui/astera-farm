...
import { ADD_VOUCHER } from "@src/redux/slice/vouchersSlice";
import { Textarea } from "@src/components/ui/textarea";
import { toast } from "react-toastify";

function AddVoucher({ isAddDialogOpen, onDialogClose }) {
    const [newVoucher, setNewVoucher] = useState({
        percentage_discount: 0,
    });
    const [errors, setErrors] = useState({});
    const [selectedBenefit, setSelectedBenefit] = useState("Percentage Discount");
    ...
    if (insertResult.error) {
      ...
      return null;
        ...
        dispatch(ADD_VOUCHER({ voucher: insertResult.data }));
                ...
                selectedBenefit === "Percentage Discount" && (
                    <div className="mb-4">
                        ...
                        <Input
                            ...
                            value={newVoucher.percentage_discount}
                            className="mt-2"
                            onChange={onInputHandleChange}
