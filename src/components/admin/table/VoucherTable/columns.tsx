...
import EditVoucherDialog from "@src/components/admin/modal/EditVoucher";
      ...
      return (
        <>
          <DropdownMenu>
            ...
            <DropdownMenuContent>
              <DropdownMenuLabel>{voucher.name}</DropdownMenuLabel>
              <DropdownMenuSeparator />
              <DropdownMenuItem
          ...
          <EditVoucherDialog
            ...
            onVoucherUpdated={handleDialogClose}
          />          
          {/* <ConfirmDeleteDialog 
            product={product}
