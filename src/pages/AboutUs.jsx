...
const AboutUs = () => {
  ...
  return (
    ...
    >
      <div className="absolute lg:top-[-150px] lg:right-[-100px] md:top-[-100px] md:right-[-150px] top-[-200px] right-[-300px]">
        <img
          src={Saturn}
          alt="Saturn"
          className="object-cover w-full h-full xl:max-w-[1000px] lg:max-w-[800px] md:max-w-[700px]"
        />
      </div>
      <div className="absolute inset-0 bg-black bg-opacity-55"></div>
      <div className="max-w-[1200px] w-full flex flex-col gap-4 md:gap-8 lg:gap-12 z-10">
        <div className="flex justify-between gap-4 items-start px-4 flex-col md:flex-row border-b-4 pb-4 border-white">
          <h1 className="font-gothic text-8xl sm:text-9xl text-white text-start tracking-wide">
            ABOUT US
          </h1>
        ...
        <div className="flex flex-col gap-4 font-lato text-yellow-50 p-4">
          <img
            src={AsteraMeaning}
            alt="Astera picture meaning"
            className="max-w-[300px] w-full"
          />
          <p className="font-medium italic text-4xl sm:text-5xl lg:text-6xl">
            meaning
          </p>
          <h1 className="font-black text-4xl sm:text-5xl lg:text-6xl">
            Astera or <span className="text-yellow italic">Asteras</span> in
            greek means <span className="text-yellow">Star</span>.
          </h1>
          <span>
            <p className="text-2xl sm:text-3xl lg:text-4xl tracking-wide leading-normal font-normal lg:ml-8">
              We decided to name our farm "Astera Farms" because we believe that{" "}
              <span className="italic">hydroponics</span> and{" "}
              <span className="italic">vertical farming</span> is the future of
              farming here on earth for more of a{" "}
              <span className="italic">sustainable</span> and{" "}
              <span className="italic">efficient</span> way of providing food
        ...
        <div className="flex flex-col gap-4">
          <div className="flex flex-col md:flex-row gap-8 items-start sm:items-center md:items-start p-4">
            <img
              src={Moon1}
              alt="About Us Pic"
              className="w-full md:max-w-[350px] lg:max-w-[450px]"
            />

            <div className="flex flex-col justify-between items-start sm:gap-6 lg:gap-7 xl:gap-8 gap-4">
              <h1 className="font-gothic text-5xl sm:text-6xl lg:text-7xl">
                MARTIAN MINI FARM CONCEPT
              </h1>
              <p className="font-spartan text-yellow text-xl sm:text-2xl md:text-xl lg:text-3xl">
          ...
          <div className="flex flex-col md:flex-row gap-8 items-start sm:items-center md:items-start  p-4">
            ...
            <div className="flex flex-col justify-between items-start sm:gap-6 lg:gap-7 xl:gap-8 gap-4">
              <h1 className="font-gothic text-5xl sm:text-6xl lg:text-7xl">
                LUNAR MINI FARM CONCEPT
              </h1>
              <p className="font-spartan text-yellow text-xl sm:text-2xl lg:text-3xl">
